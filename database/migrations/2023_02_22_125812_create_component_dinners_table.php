...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('component_dinners', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('dinner_id')->constrained('dinners','id')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('component_dinners');
    }
};
