...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('component_lunches', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('lunch_id')->constrained('lunches','id')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('component_lunches');
    }
};
